...
namespace gc
{
	...
	*/
	...
	private:
		...
		enum { Page_Start, Page_Intro, Page_GameInfo, Page_GamePlay, Page_ReviewInfo, Page_GameReview, Page_FunDataInfo, Page_FunData, Page_EthnoDataInfo, Page_EthnoData, Page_End };
