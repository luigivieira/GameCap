...
#ifndef GAME_KRAVEN_MANOR_H
#define GAME_KRAVEN_MANOR_H
...
{
	/**
	 * Class used to access the game Kraven Manor.
	 */
	class GameKravenManor: public Game
	{
		Q_OBJECT
	...
	public:
		 ...
		 */
		GameKravenManor(QObject *pParent = NULL);
