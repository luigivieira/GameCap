...
#ifndef ETHNO_DATA_PAGE_H
#define ETHNO_DATA_PAGE_H
...
{
	/**
	 * Page class in the wizard application used to capture ethnographic data.
	 */
	class EthnoDataPage : public BasePage
	{
		Q_OBJECT
	public:
         ...
         * The default is NULL.
         */
		EthnoDataPage(QWidget *pParent = NULL);
